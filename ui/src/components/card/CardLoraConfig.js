    ...
    return (
      <Card className={classes.card}>
        ...
        <CardContent>
          ...
          <br/>
          <TextField label="Gateway Id" value={this.state.gwid}
          ...
          <Divider/>
          <IconButton classes={classnames(classes.expand, {[classes.expandOpen]: this.state.expanded})}
          ...
          <Collapse in={this.state.expanded} timeout="auto" unmountOnExit>
            ...
            <br/>
            <TextField required label="mqtt server" value={this.state.mqServer}
